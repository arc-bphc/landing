...
summary: 'To make an ESP8266 based temperature logger that can send temperature to an online website/database.'
...
<Image
  src='/static/images/blog/ESP8266-temp-sensor/1.png'
  alt='1'
  width='auto'
  height='auto'
/>
<Image
  src='/static/images/blog/ESP8266-temp-sensor/2.png'
  alt='1'
  width='auto'
  height='auto'
/>
<Image
  src='/static/images/blog/thumbnails/ESP8266 based temperature logger.png'
  alt='1'
  width='auto'
  height='auto'
/>